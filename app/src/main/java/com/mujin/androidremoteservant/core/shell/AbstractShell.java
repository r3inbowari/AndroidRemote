...
public abstract class AbstractShell {
    ...
    public void Swipe(int x1, int y1, int x2, int y2) {
        exec(TextUtils.join(" ", new Object[]{"input", "swipe", scaleX(x1), scaleY(y1), scaleX(x2), scaleY(y2)}));
    }

    public void Swipe(int x1, int y1, int x2, int y2, int time) {
        exec(TextUtils.join(" ", new Object[]{"input", "swipe", scaleX(x1), scaleY(y1), scaleX(x2), scaleY(y2), time}));
    }
